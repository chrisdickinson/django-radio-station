...
def event_detail_context(request, slug, year=None, month=None, day=None):
    ...
    return ctxt
event_detail = view_to_template('radio.events/event_detail.html')(event_detail_context)
...
def events_for_day_context(request, year=None, month=None, day=None):
    ...
    return ctxt
events_for_day = view_to_template('radio.events/event_list.html')(events_for_day_context)
...
def events_for_location_context(request, slug):
    ...
    return ctxt
events_for_location = view_to_template('radio.events/event_list_location.html')(events_for_location_context)
