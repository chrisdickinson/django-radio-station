...
class ScheduleAdmin(admin.ModelAdmin):
    ...
    def get_urls(self):
        ...
        my_urls = patterns('',
            url(r'^generate/(?P<schedule_pk>\d+)', 'station.schedule.views.generate_schedule', name='generate_schedule'),
            url(r'^edit/(?P<schedule_pk>\d+)', 'station.schedule.views.edit_schedule', name='edit_schedule')
        )
        return my_urls + urls
